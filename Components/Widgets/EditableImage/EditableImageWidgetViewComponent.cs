...
using RBT.Kentico.Xperience.Custom.Widgets.EditableImage;
using System;
using System.Linq;
...
[assembly:
    RegisterWidget(
        ...
        name: "EditableImage Widget",
        propertiesType: typeof(EditableImageWidgetProperties),
        Description = "Editable Image Widget",
        IconClass = "icon-picture")]

namespace RBT.Kentico.Xperience.Custom.Widgets.EditableImage;

public class EditableImageWidgetViewComponent:ViewComponent
{
    public const string IDENTIFIER = "RBT.XBYK.Custom.Widgets.EditableImage";
